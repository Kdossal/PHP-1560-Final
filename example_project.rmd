...
ui <- fluidPage(
    ...
    # Adding dynamic check boxes for which studies to include in a side panel
    sidebarPanel(
    ...
    mainPanel(
        actionButton("plot_desc", "Tell me about the plot."),
        br(),
        div(class="main_plt", 
...
server <- function(input, output) {
    ...
    plotPopup <- observeEvent(input$plot_desc, {
        showModal(modalDialog(title = "Plot Description", 
                    HTML("You should know what this means."))) 
    })
    ...
    output$distPlot <- renderPlot({
        ...
        p <- ggplot(data = df_f) + 
            ...
            labs(x="Measurement", y = "Density", 
                 title = "Distribution of Measurement by Treatment/Control Group") 
        return(p)
    })
